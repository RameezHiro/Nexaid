                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex flex-col space-y-2">
                      <label htmlFor="volunteer-name" className="text-on-surface font-label text-xs uppercase tracking-widest font-bold">Full Name</label>
                      <input
                        id="volunteer-name"
                        type="text"
                    ...
                    <div className="flex flex-col space-y-2">
                      <label htmlFor="volunteer-location" className="text-on-surface font-label text-xs uppercase tracking-widest font-bold">Location</label>
