    ...
    <header className="w-full top-0 sticky z-50 bg-background dark:bg-slate-950 border-none">
      <nav className="flex justify-between items-center px-8 py-4 max-w-[1440px] mx-auto">
        ...
        <div className="flex items-center space-x-4">
          <button className="px-5 py-2 text-sm font-semibold text-on-surface hover:text-[#0058be] transition-colors scale-95 active:opacity-80">Sign In</button>
          <button className="px-5 py-2 text-sm font-semibold bg-primary bg-linear-to-br from-primary to-primary-container text-on-primary rounded-lg shadow-sm scale-95 active:opacity-80 transition-transform">Get Started</button>
        </div>
      </nav>
    </header>
  );
    ...
    <footer className="w-full py-12 bg-[#111c2d] dark:bg-black">
      <div className="flex flex-col md:flex-row justify-between items-center px-12 border-t border-slate-800 max-w-[1440px] mx-auto pt-12 space-y-8 md:space-y-0">
        <div className="flex flex-col items-center md:items-start gap-2">
          <div className="text-white font-bold text-xl">VolunteerBridge</div>
          <p className="text-slate-400 font-body text-sm">© 2024 VolunteerBridge. Algorithmic Coordination.</p>
